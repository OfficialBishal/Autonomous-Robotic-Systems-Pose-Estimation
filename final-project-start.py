...
PACKAGE_NAME = "final-project-OfficialBishal"
...
# World file is now in the final-project-OfficialBishal package
...
# Use RViz config from final-project-OfficialBishal package
RVIZ_NAME = 'hsr.rviz'
