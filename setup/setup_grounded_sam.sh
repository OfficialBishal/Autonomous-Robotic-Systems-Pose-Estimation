...
python -c "
import sys
sys.path.insert(0, '$HOME/hsr_robocanes_omniverse/Grounded-Segment-Anything')
try:
...
echo "  4. Test: roslaunch final-project-OfficialBishal foundationpose_with_grounded_sam.launch"
echo ""
echo "Checkpoint location:"
echo "  ~/hsr_robocanes_omniverse/Grounded-Segment-Anything/checkpoints/groundingdino_swint_ogc.pth"
echo ""
